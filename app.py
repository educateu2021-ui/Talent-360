...
# ---------- DATABASE ----------
# UPDATED VERSION TO v20 TO FORCE FRESH DB CREATION
DB_FILE = "portal_v20_production.db"
...
def init_db():
    ...
    # 3. RESOURCE TRACKER TABLE (v4 with Financial Columns)
    ...
    # Resource Tracker Demo Data (10 Entries with Cost)
    ...
    if c.fetchone()[0] == 0:
        resources = [
            ...
            (str(uuid.uuid4())[:8], "Charlie Davis", "EMP003", "089", "Manufacturing", "Remote", "Sarah Jenkins", "2023-11-01", "EXPERT", "Inactive", "PO-445566", "Resigned", "2024-12-01", "Yes", "Higher Salary", "50", "0"),
            ...
            (str(uuid.uuid4())[:8], "Fiona Green", "EMP006", "005", "Engineering", "Chennai", "Sarah Jenkins", "2023-12-10", "MID", "Inactive", "PO-223344", "Personal", "2024-11-15", "No", "Relocation", "25", "5"),
